...
if (search == 'BASIC'):
    basic_search_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/basic_search.txt')
...
if (search == 'ADVANCED'):
    advanced_search_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/advanced_search.txt')
...
if (paypal_payment == '1'):
    paypal_payment_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/paypal_payment.txt')
...
if (creditcard_payment == '1'):
    creditcard_payment_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/creditcard_payment.txt')
...
if (mobile_payment == '1'):
    mobile_payment_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/mobile_payment.txt')
...
if (security == 'HIGH'):
    high_security_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/high_security.txt')
...
if (security == 'STANDARD'):
    standard_security_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/standard_security.txt')
...
if (backup == '1'):
    backup_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/backup.txt')
...
if (seo == '1'):
    seo_plugin_file = open(os.getenv('HOME_PATH') +
                           '/webspl/app/Runner/features/seo.txt')
...
if (twitter_socials == '1'):
    twitter_socials_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/twitter_socials.txt')
...
if (facebook_socials == '1'):
    facebook_socials_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/facebook_socials.txt')
...
if (youtube_socials == '1'):
    youtube_socials_plugin_file = open(
        os.getenv('HOME_PATH') + '/webspl/app/Runner/features/youtube_socials.txt')
...
os.system("cd " + ENV + "/generated-websites && mkdir " + web_name + " && cd " +
          web_name + " && git clone https://github.com/joszamama/auto-wp.git")
...
for line in reading_file:
    ...
    new_line = stripped_line.replace(
        'COMPOSE_PROJECT_NAME=wordpress', 'COMPOSE_PROJECT_NAME=' + web_name)
    new_file_content += new_line + "\n"
reading_file.close()
writing_file = open(ENV + "/generated-websites/" +
                    web_name + "/auto-wp/.env", "w")
...
for line in reading_file:
    stripped_line = line.strip()
    new_line = stripped_line.replace(
        'WORDPRESS_WEBSITE_URL=http://localhost:WP_PORT', 'WORDPRESS_WEBSITE_URL=http://localhost:' + WP_PORT)
    new_file_content += new_line + "\n"
reading_file.close()
writing_file = open(ENV + "/generated-websites/" +
                    web_name + "/auto-wp/.env", "w")
...
for line in reading_file:
    stripped_line = line.strip()
    new_line = stripped_line.replace('WORDPRESS_WEBSITE_URL_WITHOUT_HTTP=localhost:WP_PORT',
                                     'WORDPRESS_WEBSITE_URL_WITHOUT_HTTP=localhost:' + WP_PORT)
    new_file_content += new_line + "\n"
reading_file.close()
writing_file = open(ENV + "/generated-websites/" +
                    web_name + "/auto-wp/.env", "w")
...
for line in reading_file:
    stripped_line = line.strip()
    new_line = stripped_line.replace(
        'WORDPRESS_PORTING=WP_PORT', "WORDPRESS_PORTING=" + WP_PORT)
    new_file_content += new_line + "\n"
reading_file.close()
writing_file = open(ENV + "/generated-websites/" +
                    web_name + "/auto-wp/.env", "w")
...
for line in reading_file:
    stripped_line = line.strip()
    new_line = stripped_line.replace(
        'PHPMYADMIN_PORT=PHPMYADMIN_PORT', 'PHPMYADMIN_PORT=' + PHPMYADMIN_PORT)
    new_file_content += new_line + "\n"
reading_file.close()
writing_file = open(ENV + "/generated-websites/" +
                    web_name + "/auto-wp/.env", "w")
...
os.system("cd " + ENV + "/generated-websites/" + web_name +
          "/auto-wp && sudo docker-compose run --rm wpcli theme install " + theme + " --activate")

for plugin in plugin_list:
    os.system("cd " + ENV + "/generated-websites/" + web_name +
              "/auto-wp && sudo docker-compose run --rm wpcli plugin install " + plugin + " --activate")

os.system("cd " + ENV + "/generated-websites/ && zip -r " +
          web_name + ".zip " + web_name)
os.system("cd " + ENV + "/generated-websites/ && mv " + web_name +
          ".zip " + ENV + "/webspl/storage/app/" + username + "/")

...
class ConfigurationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $port_detector = new Process(['python3', app_path('Runner/detector.py')]);
            $port_detector->run();
        ...
        try {
            ...
            $flama = new Process(['python3', app_path('Runner/flama.py'), $web_name, $admin_email, $theme, $php, $storage, $catalog, $search, $paypal_payment, $creditcard_payment, $mobile_payment, $cart, $security, $backup, $seo, $twitter_socials, $facebook_socials, $youtube_socials]);
            $flama->run();
    ...
    public function stop(Request $request, $id)
    {
        ...
        try {
            ...
            $stopper = new Process(['python3', app_path('Runner/stopper.py'), $web_name]);
            $stopper->run();
    ...
    public function start(Request $request, $id)
    {
        ...
        try {
            ...
            $starter = new Process(['python3', app_path('Runner/starter.py'), $web_name]);
            $starter->run();
    ...
    public function destroy($id)
    {
        try {
            ...
            $destroyer = new Process(['python3', app_path('Runner/destroyer.py'), $web_name]);
            $destroyer->run();
